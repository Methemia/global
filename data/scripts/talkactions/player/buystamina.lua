local buystamina = TalkAction("!buystaminajskjdskjdksjdkjsk")

function buystamina.onSay(player, words, param)

  local goldMultiplier = 500 --this is the price for 1 minute of regular stamina
