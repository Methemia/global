...
function warzoneEntrance.onStepIn(creature, item, position, fromPosition, toPosition)
	...
	if item:getPosition() == Position(33829, 32128, 14) then
		if player:setStorageValue(Storage.DangerousDepths.Access.LavaPumpWarzoneVI) == 1 and
	...
	if item:getPosition() == Position(33777, 32192, 14) then
		if player:setStorageValue(Storage.DangerousDepths.Access.LavaPumpWarzoneV) == 1 and
	...
	if item:getPosition() == Position(33827, 32172, 14) then
		if player:setStorageValue(Storage.DangerousDepths.Access.LavaPumpWarzoneIV) == 1 and
