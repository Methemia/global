local destination = {
	...
	[3132] = {position = Position(32988, 31862, 9), storageValue = 1}, -- gnomebase alpha
	[3133] = {position = Position(32798, 31783, 10), storageValue = 1}, -- city
	[3134] = {position = Position(32959, 31953, 9), storageValue = 1}, -- golems
	[3135] = {position = Position(33001, 31915, 9), storageValue = 1}, -- back from golems
	[3136] = {position = Position(32904, 31894, 13), storageValue = 1}, -- vulcongras
	[3137] = {position = Position(32979, 31907, 9), storageValue = 1}, -- back from vulcongras
	...
	[3222] = {position = Position(32771, 31800, 10), storageValue = 1, needCrystal = false},
	[3221] = {position = Position(32790, 31795, 10), storageValue = 1, needCrystal = false}
}
