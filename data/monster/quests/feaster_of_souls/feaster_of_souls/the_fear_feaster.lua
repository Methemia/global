...
monster.health = 48700
monster.maxHealth = 48700
monster.race = "blood"
...
monster.loot = {
	...
	{name = "soulforged lantern", chance = 140},
	{name = "grimace", chance = 5880},
	{name = "amber", chance = 180},
	{name = "amber with a dragonfly", chance = 120},
	{name = "ghost claw", chance = 160},
	{name = "bloody tears", chance = 320},
...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 15, type = COMBAT_DEATHDAMAGE, minDamage = -400, maxDamage = -1000, length = 7, shootEffect = CONST_ANI_SMALLCLOUDS, target = false},
	{name ="combat", interval = 2000, chance = 12, type = COMBAT_PHYSICALDAMAGE, minDamage = -500, maxDamage = -800, length = 8, spread = 3, effect = CONST_ME_DRAWBLOOD, target = false},
	{name ="thefearfeasterdeathring", interval = 2000, chance = 10, minDamage = -350, maxDamage = -1000, target = false},
	{name ="thefearfeasterdeathringbig", interval = 2000, chance = 10, minDamage = -350, maxDamage = -1000, target = false},
	{name ="thefearfeasterdeathringsmall", interval = 2000, chance = 10, minDamage = -350, maxDamage = -1000, target = false},
	{name ="thefearfeasterdeathringsmaller", interval = 2000, chance = 10, minDamage = -350, maxDamage = -1000, target = false}
}
