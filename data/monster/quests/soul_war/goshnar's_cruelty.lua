...
monster.loot = {
	...
	{id = 8889, chance = 100},-- skullcracker armor -->		
	{id = 7418, chance = 200},-- nightmare blade -->		
	{id = 7589, chance = 7500},-- strong mana potion -->		
	{id = 8910, chance = 5000},-- underworld rod -->		
	{id = 8473, chance = 7777},-- ultimate health potion -->
	{id = 8920, chance = 500},-- wand of starstorm -->	
	{id = 8889, chance = 100,},-- skullcracker armor -->		
	{id = 7418, chance = 200,},-- nightmare blade -->		
	{id = 38758, chance = 100,},-- cruelty's chest -->		
	{id = 38757, chance = 100,},-- cruelty's claw -->		
...
monster.attacks = {
	...
	{name ="combat", interval = 1000, chance = 15, type = COMBAT_LIFEDRAIN, minDamage = 1650, maxDamage = -1850, length = 8, spread = 3, effect = CONST_ME_YELLOWENERGY, target = false},
	{name ="combat", interval = 1000, chance = 40, type = COMBAT_PHYSICALDAMAGE, minDamage = -750, maxDamage = -2480, length = 4, spread = 2, effect = CONST_ME_MORTAREA, target = false},
	{name ="combat", interval = 1000, chance = 40, type = COMBAT_PHYSICALDAMAGE, minDamage = -840, maxDamage = -1280, length = 6, spread = 0, effect = CONST_ME_GROUNDSHAKER, target = false},
	...
	{name ="combat", interval = 1000, chance = 15, type = COMBAT_MANADRAIN, minDamage = -535, maxDamage = -1615, range = 8, radius = 4, effect = CONST_ME_YELLOWENERGY, target = true},
	...
	{name ="combat", interval = 1000, chance = 10, type = COMBAT_DEATHDAMAGE, minDamage = -610, maxDamage = -1990, range = 7, shootEffect = CONST_ANI_MORTAREA, target = true},
	...
	{name ="big death wave", interval = 2000, chance = 10, minDamage = -400, maxDamage = -1200, range = 5, target = false},
}
