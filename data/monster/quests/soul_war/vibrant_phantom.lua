...
monster.attacks = {
	{name ="combat", interval = 3000, chance = 15, type = COMBAT_HOLYDAMAGE, minDamage = -1200, maxDamage = -1400, range = 7, shootEffect = CONST_ANI_SMALLHOLY, effect = CONST_ME_HOLYDAMAGE, target = true},
	{name ="combat", interval = 2000, chance = 25, type = COMBAT_ENERGYDAMAGE, minDamage = -950, maxDamage = -1300, range = 7, radius = 4, shootEffect = CONST_ANI_ENERGY, effect = CONST_ME_ENERGYAREA, target = true},
	{name ="combat", interval = 3000, chance = 13, type = COMBAT_ENERGYDAMAGE, minDamage = -950, maxDamage = -1200, range = 7, radius = 4, effect = CONST_ME_ENERGYAREA, target = false},
	{name ="combat", interval = 2000, chance = 22, type = COMBAT_ENERGYDAMAGE, minDamage = -950, maxDamage = -1200, range = 7, radius = 4, effect = CONST_ME_ENERGYAREA, target = false}
