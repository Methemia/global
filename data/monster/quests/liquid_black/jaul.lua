...
monster.loot = {
	{name = "deepling axe", chance = 1700},
	{name = "depth calcei", chance = 1300},
	{id = 15408, chance = 1500},-- depth galea
	{name = "depth lorica", chance = 1000},
	{name = "ornate chestplate", chance = 850, unique = true},
	{name = "ornate legs", chance = 940},
	{name = "ornate mace", chance = 1700},
	{name = "ornate shield", chance = 1600}
}
