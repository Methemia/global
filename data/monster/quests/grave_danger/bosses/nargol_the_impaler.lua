...
monster.attacks = {
	...
	{name ="combat", interval = 4000, chance = 30, minDamage = -300, maxDamage = -500, type = COMBAT_EARTH, length = 8, spread = 3, effect = CONST_ME_GREEN_RINGS, target = false},
	{name ="combat", interval = 6000, chance = 30, minDamage = -500, maxDamage = -800, type = COMBAT_EARTH, length = 8, spread = 3, effect = CONST_ME_GREEN_RINGS, target = false},
}
