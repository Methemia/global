...
monster.loot = {
	...
	{name = "berserk potion", chance = 100, maxCount = 10},
	{name = "flash arrow", chance = 300, maxCount = 100},
	{name = "crystal coin", chance = 12000, maxCount = 3},
	{name = "silver token", chance = 9000, maxCount = 3},
	{name = "mastermind potion", chance = 120, maxCount = 10},
	...
	{name = "bullseye potion", chance = 30, maxCount = 10},
	{name = "lightning pendant", chance = 30},
	{name = "giant ruby", chance = 6000},
	{name = "urmahlullu's mane", chance = 30},
	{name = "urmahlullu's paw", chance = 30},
	{name = "urmahlullu's tail", chance = 30},
	{name = "tagralt blade", chance = 30},
	{name = "winged boots", chance = 30},
	...
	{id = 36098, chance = 30},
	{name = "rainbow necklace", chance = 30},
	{name = "giant sapphire", chance = 30},
	{name = "winged backpack", chance = 30},
	{name = "rainbow necklace", chance = 40},
	{id = 35238, chance = 30},
	{name = "Sun Medal", chance = 30},
	{name = "Sunray Emblem", chance = 30}
}
