...
monster.summons = {
	{name = "preceptor lazaree", chance = 10, interval = 8000},
	{name = "grand commander soerenn", chance = 10, interval = 8000},
	{name = "grand chaplain gaunderr", chance = 10, interval = 8000}
}
