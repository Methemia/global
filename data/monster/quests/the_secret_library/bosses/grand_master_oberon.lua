...
monster.loot = {
	...
	{name = "falcon battleaxe", chance = 85, maxCount = 1},
	{name = "falcon longsword", chance = 85, maxCount = 1},
	{name = "falcon mace", chance = 85, maxCount = 1},
	{name = "grant of arms", chance = 80, maxCount = 1},
	{name = "falcon bow", chance = 85, maxCount = 1},
	{name = "falcon circlet", chance = 85, maxCount = 1},
	{name = "falcon coif", chance = 85, maxCount = 1},
	{name = "falcon rod", chance = 85, maxCount = 1},
	{name = "falcon wand", chance = 85, maxCount = 1},
	{name = "falcon shield", chance = 85, maxCount = 1},
	{name = "falcon greaves", chance = 85, maxCount = 1},
	{name = "falcon plate", chance = 85, maxCount = 1},
}

monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = 0, maxDamage = -1200},
	{name ="combat", interval = 6000, chance = 80, type = COMBAT_HOLYDAMAGE, minDamage = -1000, maxDamage = -1950, length = 8, spread = 3, effect = CONST_ME_HOLYAREA, target = false},
	{name ="combat", interval = 1000, chance = 20, type = COMBAT_EARTHDAMAGE, minDamage = -820, maxDamage = -1250, radius = 5, effect = CONST_ME_HITAREA, target = false},
