...
monster.loot = {
	...
	{name = "falcon battleaxe", chance = 20, maxCount = 1},
	{name = "falcon longsword", chance = 20, maxCount = 1},
	{name = "falcon mace", chance = 20, maxCount = 1},
	{name = "grant of arms", chance = 80, maxCount = 1},
	{name = "falcon bow", chance = 20, maxCount = 1},
	{name = "falcon circlet", chance = 20, maxCount = 1},
	{name = "falcon coif", chance = 20, maxCount = 1},
	{name = "falcon rod", chance = 20, maxCount = 1},
	{name = "falcon wand", chance = 20, maxCount = 1},
	{name = "falcon shield", chance = 20, maxCount = 1},
	{name = "falcon greaves", chance = 20, maxCount = 1},
	{name = "falcon plate", chance = 20, maxCount = 1},
}
