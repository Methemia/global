...
monster.attacks = {
	{name ="melee", interval = 1500, chance = 100, minDamage = -300, maxDamage = -500, effect = CONST_ME_DRAWBLOOD},
	...
	{name ="combat", interval = 3000, chance = 15, type = COMBAT_PHYSICALDAMAGE, minDamage = -350, maxDamage = -400, range = 5, shootEffect = CONST_ANI_LARGEROCK, target = false},
