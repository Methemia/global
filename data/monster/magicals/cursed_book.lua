...
monster.attacks = {
	...
	{name ="combat", interval = 1000, chance = 15, type = COMBAT_PHYSICALDAMAGE, minDamage = -500, maxDamage = -780, range = 7, shootEffect = CONST_ANI_EARTHARROW, target = false},
	{name ="combat", interval = 1000, chance = 10, type = COMBAT_LIFEDRAIN, minDamage = -500, maxDamage = -900, length = 5, spread = 3, effect = CONST_ME_POISONAREA, target = false},
