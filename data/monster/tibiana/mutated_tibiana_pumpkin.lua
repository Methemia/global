local mType = Game.createMonsterType("Mutated Tibiana Pumpkin")
local monster = {}

monster.description = "Mutated Tibiana Pumpkin"
...
monster.loot = {
	...
	{id = 6571, chance = 1000},
	{id = 2096, chance = 1000},
	{id = 6527, chance = 5680000, maxCount = 25}
}

monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, skill = 105, attack = 85},
	{name ="combat", interval = 3000, chance = 18, type = COMBAT_MANADRAIN, minDamage = -100, maxDamage = -400, range = 7, effect = CONST_ME_MAGIC_RED, target = true},
