...
monster.loot = {
	...
	{name = "hailstorm rod", chance = 30000},
...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 10, type = COMBAT_ICEDAMAGE, minDamage = -100, maxDamage = -300, radius = 3, effect = CONST_ME_ICEAREA, target = true},
	{name ="combat", interval = 2000, chance = 10, type = COMBAT_ICEDAMAGE, minDamage = -100, maxDamage = -300, range = 7, shootEffect = CONST_ANI_ICE, target = false}
}
