...
local shop = {
	{id=11302, buy=2, sell=0, name='zaoan helmet'},
	{id=11301, buy=2, sell=0, name='zaoan armor'},
	{id=11304, buy=2, sell=0, name='zaoan legs'},

	{id=18403, buy=3, sell=0, name='prismatic helmet'},
	{id=18404, buy=3, sell=0, name='prismatic armor'},
	{id=18405, buy=3, sell=0, name='prismatic legs'},
}
...
local function creatureSayCallback(cid, type, msg)
	...
	elseif msgcontains(msg, "trade") then
		npcHandler:say({"You have chosen "..msg..". {tokens}?"}, cid)
