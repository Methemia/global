...
local shop = {
	{id=30686, buy=1, sell=0, name='axe of desctruction'},
	{id=30684, buy=1, sell=0, name='blade of desctruction'},
	{id=30690, buy=1, sell=0, name='bow of desctruction'},
	{id=30687, buy=1, sell=0, name='chopper of desctruction'},
	{id=30691, buy=1, sell=0, name='crossbow of desctruction'},
	{id=30689, buy=1, sell=0, name='hammer of desctruction'},
	{id=30688, buy=1, sell=0, name='mace of desctruction'},
	{id=30693, buy=1, sell=0, name='rod of desctruction'},
	{id=30685, buy=1, sell=0, name='slayer of desctruction'},
	{id=30692, buy=1, sell=0, name='wand of desctruction'},
}
...
local products = {
	['strike'] = {
		['basic'] =  {
			text = "The basic bundle for the strike imbuement consists of 5 protective charms. Would you like to buy it for 1 ".. ItemType(Npc():getCurrency()):getPluralName():lower() .."?",
			itens = {
				[1] = {id = 12400, amount = 5}
			},
			value = 2
		...
		['intricate'] =  {
			text = "The intricate bundle for the strike imbuement consists of 5 protective charms and 5 sabreteeth. Would you like to buy it for 4 ".. ItemType(Npc():getCurrency()):getPluralName():lower() .."?",
			itens = {
				[1] = {id = 12400, amount = 5},
				[2] = {id = 11228, amount = 5}
			},
		...
		['powerful'] = {
			text = "The powerful bundle for the strike imbuement consists of 5 protective charms, 5 sabreteeth and 1 vexclaw talons. Would you like to buy it for 6 ".. ItemType(Npc():getCurrency()):getPluralName():lower() .."?",
			itens = {
				[1] = {id = 12400, amount = 5},
				[2] = {id = 11228, amount = 5},
				[3] = {id = 25384, amount = 1}
	...
	['vampirism'] = {
		['basic'] =  {
			text = "The basic bundle for the vampirism imbuement consists of 5 vampire teeth. Would you like to buy it for 2 ".. ItemType(Npc():getCurrency()):getPluralName():lower() .."?",
			itens = {
				[1] = {id = 10602, amount = 5}
			},
			value = 2
		...
		['powerful'] = {
			text = "The powerful bundle for the vampirism imbuement consists of 5 vampire teeth, 5 bloody pincers and 1 pieces of dead brain. Would you like to it for 6 ".. ItemType(Npc():getCurrency()):getPluralName():lower() .."?",
			itens = {
				[1] = {id = 10602, amount = 5},
				[2] = {id = 10550, amount = 5},
				[3] = {id = 10580, amount = 1}
	...
	['void'] = {
		['basic'] =  {
			text = "The basic bundle for the void imbuement consists of 5 rope belts. Would you like to buy it for 2 ".. ItemType(Npc():getCurrency()):getPluralName():lower() .."?",
			itens = {
				[1] = {id = 12448, amount = 5}
			},
			value = 2,
		...
		['intricate'] =  {
			text = "The intricate bundle for the void imbuement consists of 5 rope belts and 5 silencer claws. Would you like to buy it for 4 ".. ItemType(Npc():getCurrency()):getPluralName():lower() .."?.",
			itens = {
				[1] = {id = 12448, amount = 5},
				[2] = {id = 22534, amount = 5}
			},
		...
		['powerful'] = {
			text = "The powerful bundle for the void imbuement consists of 5 rope belts, 5 silencer claws and 1 grimeleech wings. Would you like to buy it for 6 ".. ItemType(Npc():getCurrency()):getPluralName():lower() .."?",
			itens = {
				[1] = {id = 12448, amount = 5},
				[2] = {id = 22534, amount = 5},
				[3] = {id = 25386, amount = 1}
