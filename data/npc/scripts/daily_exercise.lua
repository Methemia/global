...
local voices = {
{ text = "Get your free daily exercise weapon here!!" }
}
...
npcHandler:say("Rewards can only be collected every 24 hours", cid)
...
player:setStorageValue(config.str, os.time() + (24 * 60 * 60))
npcHandler.topic[cid] = 0
end
