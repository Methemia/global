...
function creatureSayCallback(cid, type, msg)
	...
	elseif msgcontains(msg, 'enchant') then
		npcHandler:say("The following items can be enchanted: {pendulet}, {sleep shawl}, {blister ring}, {theurgic amulet}, {ring of souls}. Make you choice!", cid)
		npcHandler.topic[cid] = 1
	elseif isInArray({'pendulet', 'sleep shawl', 'blister ring', 'theurgic amulet', 'ring of souls'}, msg:lower()) and npcHandler.topic[cid] == 1 then
