...
HomeBanners = {
   images = {"home/banner_runemaster.png", "home/banner_podiumofrenown.png"},
   delay = 10
}
...
GameStore.Categories = {
    {
        ...
        name = "Extra Services",
        rookgaard = true,
        subclasses = {"Services", "Sorcerer", "Druid", "Paladin", "Knight"}
    },
    -- Blessings
    {
        icons = {"Category_Runes.png"},
        name = "Services",
        parent = "Extra Services",
        rookgaard = true,
        state = GameStore.States.STATE_NONE,
        offers = {
            {
                name = "Temple Teleport", count = 1, type = GameStore.OfferTypes.OFFER_TYPE_TEMPLE, price = 10, icons = {"Temple_Teleport.png"}, description = "Teleports you instantly to your home temple."},	
			{name = "Skull Remover", price = 150, type = GameStore.OfferTypes.OFFER_TYPE_ITEM, itemtype = 11144, count = 1, icons = {"blackskull.png"}, description = "skull remover."},
			{name = "Character Name Change", type = GameStore.OfferTypes.OFFER_TYPE_NAMECHANGE, price = 250, icons = {"Name_Change.png"}, description = "Change your name."},
			{name = "Character Sex Change", type = GameStore.OfferTypes.OFFER_TYPE_SEXCHANGE, price = 100, icons = {"Sex_Change.png"}, description = "Change your sex."},
			{name = "XP Boost 50% (1 hora)", type = GameStore.OfferTypes.OFFER_TYPE_EXPBOOST, price = 30, home = true, icons = {"XP_Boost.png"}, description = "Bonus experience."},
			{name = "Charm Expansion", type = GameStore.OfferTypes.OFFER_TYPE_CHARMS, price = 450, id = 65005, icons = {"Charm_Expansion_Offer.png"}, description = "charm expansion."},
			{name = "Prey Bonus Reroll x5", count = 5, type = GameStore.OfferTypes.OFFER_TYPE_PREYBONUS, price = 25, icons = {"Prey_Bonus_Reroll.png"}, description = "Prey re roll."},
			{name = "Prey Bonus Reroll x20", count = 20, type = GameStore.OfferTypes.OFFER_TYPE_PREYBONUS, price = 100, icons = {"Prey_Bonus_Reroll.png"}, description = "Prey re roll."},
			{name = "Permanent Prey Slot", id = 65008, type = GameStore.OfferTypes.OFFER_TYPE_PREYSLOT, price = 450, icons = {"Permanent_Prey_Slot.png"}, description = "last Prey slot."},
        		 {name = "Time Waster", price = 1800, type = GameStore.OfferTypes.OFFER_TYPE_ITEM, itemtype = 27631, count = 1, icons = {"27631.png"}, description = "{info} Faster Regeneration HP \n{activated}\n{info} 25 hp per second\n{info} Critical 2%\n {info} Critical chance 1%\n"},
        {name = "Tibia Coins x 500", price = 500, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 24774, count = 500, icons = {"24774.png"}, description = "{info} 500 Tibia Coins en Item para tradear a jugadores en cliente Android y OTClient\n"},
        {name = "Stamina Refill - 2 hours", price = 30, type = GameStore.OfferTypes.OFFER_TYPE_ITEM, itemtype = 38763, count = 1, icons = {"38763.png"}, description = "Regenera 2 horas de stamina."},
        {name = "Full Stamina Refill", price = 500, type = GameStore.OfferTypes.OFFER_TYPE_ITEM, itemtype = 38762, count = 1, icons = {"38944.png"}, description = "Regenera toda tu stamina."},
        {name = "Faster Regeneration - 30 Days", price = 750, type = GameStore.OfferTypes.OFFER_TYPE_ITEM, itemtype = 16101, count = 1, icons = {"16101.png"}, description = "{info} Faster Regeneration\n{activated}\n{info} 25 mana per second\n{info} 25 health per second\n{info} Bonus experience 10%\n{info} Bonus Loot 10%\n{info} 3 Free Mounts\n {info} Free Recruiter Outfit\n"},
    ...
    -- Blessings
    {
        ...
        state = GameStore.States.STATE_NONE,
        offers = {
        {name = "Earthmind Raiment", price = 425, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 25191, count = 1, icons = {"25191.png"}, description = "proximamente"},
        {name = "Falcon Circlet", price = 575, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 32414, count = 1, icons = {"32414.png"}, description = "proximamente"},
        {name = "Falcon Wand", price = 575, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 32417, count = 1, icons = {"32417.png"}, description = "proximamente"},
        {name = "Gill Gugel", price = 375, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 18398, count = 1, icons = {"18398.png"}, description = "proximamente"},
      {name = "Gill Legs", price = 425, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 18400, count = 1, icons = {"18400.png"}, description = "proximamente"},
      {name = "Lion Amulet", price = 475, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 38993, count = 1, icons = {"38993.png"}, description = "proximamente"},
      {name = "Lion Spellbook", price = 425, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 38988, count = 1, icons = {"38988.png"}, description = "proximamente"},
      {name = "Lion Wand", price = 475, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 38987, count = 1, icons = {"38987.png"}, description = "proximamente"},
      {name = "Pair Of Nightmare Boots", price = 625, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 37454, count = 1, icons = {"37454.png"}, description = "proximamente"},
      {name = "Spellbook of Ancient Arcana", price = 375, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 16112, count = 1, icons = {"16112.png"}, description = "proximamente"},
      {name = "Umbral Master Spellbook", price = 525, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 22424, count = 1, icons = {"22424.png"}, description = "proximamente"},
      {name = "Wand of Destruction", price = 225, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 30692, count = 1, icons = {"30692.png"}, description = "proximamente"},
    ...
    -- Blessings
    {
        ...
        offers = {
               {name = "Earthmind Raiment", price = 425, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 25191, count = 1, icons = {"25191.png"}, description = "proximamente"},
        {name = "Falcon Circlet", price = 575, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 32414, count = 1, icons = {"32414.png"}, description = "proximamente"},
        {name = "Falcon Rod", price = 575, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 32416, count = 1, icons = {"32416.png"}, description = "proximamente"},
        {name = "Gill Gugel", price = 375, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 18398, count = 1, icons = {"18398.png"}, description = "proximamente"},
      {name = "Gill Legs", price = 425, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 18400, count = 1, icons = {"18400.png"}, description = "proximamente"},
      {name = "Lion Amulet", price = 475, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 38993, count = 1, icons = {"38993.png"}, description = "proximamente"},
      {name = "Lion Spellbook", price = 425, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 38988, count = 1, icons = {"38988.png"}, description = "proximamente"},
      {name = "Lion Rod", price = 475, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 38986, count = 1, icons = {"38986.png"}, description = "proximamente"},
      {name = "Pair Of Nightmare Boots", price = 625, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 37454, count = 1, icons = {"37454.png"}, description = "proximamente"},
      {name = "Spellbook of Ancient Arcana", price = 375, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 16112, count = 1, icons = {"16112.png"}, description = "proximamente"},
      {name = "Umbral Master Spellbook", price = 525, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 22424, count = 1, icons = {"22424.png"}, description = "proximamente"},
      {name = "Wand of Destruction", price = 225, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 30693, count = 1, icons = {"30693.png"}, description = "proximamente"},
    ...
    -- Blessings
    {
        ...
        state = GameStore.States.STATE_NONE,
        offers = {
                     {name = "Bow of Destruction", price = 275, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 30690, count = 1, icons = {"30690.png"}, description = "proximamente"},
                     {name = "Crossbow of Destruction", price = 275, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 30691, count = 1, icons = {"30691.png"}, description = "proximamente"},
                     {name = "Falcon Bow", price = 575, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 32418, count = 1, icons = {"32418.png"}, description = "proximamente"},
                     {name = "Falcon Coif", price = 575, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 32415, count = 1, icons = {"32415.png"}, description = "proximamente"},
       		     {name = "Falcon Greaves", price = 575, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 32420, count = 1, icons = {"32420.png"}, description = "proximamente"},
      {name = "Jungle Quiver", price = 75, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 40359, count = 1, icons = {"40359.png"}, description = "proximamente"},
      {name = "Lion Amulet", price = 425, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 38993, count = 1, icons = {"38993.png"}, description = "proximamente"},
      {name = "Lion Longbow", price = 425, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 38985, count = 1, icons = {"38985.png"}, description = "proximamente"},
      {name = "Lion Spangenhelm", price = 475, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 38991, count = 1, icons = {"38991.png"}, description = "proximamente"},
    ...
    -- Blessings
    {
        ...
        state = GameStore.States.STATE_NONE,
        offers = {
                         {name = "Axe of Destruction", price = 275, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 30686, count = 1, icons = {"30686.png"}, description = "proximamente"},
                     {name = "Blade of Destruction", price = 275, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 30684, count = 1, icons = {"30684.png"}, description = "proximamente"},
                     {name = "Chopper of Destruction", price = 275, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 30687, count = 1, icons = {"30687.png"}, description = "proximamente"},
                     {name = "Earthheart Cuirass", price = 575, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 25177, count = 1, icons = {"25177.png"}, description = "proximamente"},
      {name = "Falcon Battleaxe", price = 575, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 32424, count = 1, icons = {"32424.png"}, description = "proximamente"},
      {name = "Falcon Coif", price = 575, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 32415, count = 1, icons = {"32415.png"}, description = "proximamente"},
      {name = "Falcon Greaves", price = 575, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 32420, count = 1, icons = {"32420.png"}, description = "proximamente"},
      {name = "Falcon Longsword", price = 575, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 32423, count = 1, icons = {"32423.png"}, description = "proximamente"},
      {name = "Falcon Mace", price = 575, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 32425, count = 1, icons = {"32425.png"}, description = "proximamente"},
      {name = "Falcon Plate", price = 575, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 32419, count = 1, icons = {"32419.png"}, description = "proximamente"},
      {name = "Falcon Shield", price = 575, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 32421, count = 1, icons = {"32421.png"}, description = "proximamente"},
      {name = "Hammer of Destruction", price = 275, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 30689, count = 1, icons = {"30689.png"}, description = "proximamente"},
      {name = "Lion Amulet", price = 475, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 38993, count = 1, icons = {"38993.png"}, description = "proximamente"},
      {name = "Lion Axe", price = 425, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 39088, count = 1, icons = {"39088.png"}, description = "proximamente"},
      {name = "Lion Hammer", price = 425, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 39089, count = 1, icons = {"39089.png"}, description = "proximamente"},
      {name = "Lion Longsword", price = 425, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 38990, count = 1, icons = {"38990.png"}, description = "proximamente"},
      {name = "Lion Plate", price = 425, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 38992, count = 1, icons = {"38992.png"}, description = "proximamente"},
      {name = "Lion Shield", price = 425, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 38989, count = 1, icons = {"38989.png"}, description = "proximamente"},
      {name = "Mace of Destruction", price = 275, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 30688, count = 1, icons = {"30688.png"}, description = "proximamente"},
      {name = "Phantasmal Axe", price = 925, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 37451, count = 1, icons = {"37451.png"}, description = "proximamente"},
      {name = "Slayer of Destruction", price = 275, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 30685, count = 1, icons = {"30685.png"}, description = "proximamente"},
      {name = "Summerblade", price = 475, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 34059, count = 1, icons = {"34059.png"}, description = "proximamente"},
      {name = "Terra Helmet", price = 375, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 36412, count = 1, icons = {"36412.png"}, description = "proximamente"},
      {name = "The Epiphany", price = 475, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 8931, count = 1, icons = {"8931.png"}, description = "proximamente"},
      {name = "Winterblade", price = 475, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 34060, count = 1, icons = {"34060.png"}, description = "proximamente"},
      }
    },
    {
----
        ...
        name = "Consumibles",
        rookgaard = true,
        subclasses = {"Potions - Runes", "Exercise Training and skill", "Casks"}
    },
    -- Blessings
    {
        icons = {"Category_Runes.png"},
    ...
    -- Exercise Weapons
    {
     ...
     {name = "Lasting Exercise Club",
		...
		icons = {"Exercise_Bow.png"},
                description = "<i>Use it to train your distance level on an exercise dummy!</i>\n\n{character}\n{storeinbox}\n{info} use it on an exercise dummy to train your magic level\n{info} usable 14400 times a piece",
                type = GameStore.OfferTypes.OFFER_TYPE_CHARGES},
    ...
    },
    {
        ...
        name = "Others",
        rookgaard = true,
        subclasses = {"Foods", "Objects", "Imbuements"}
    },
    -- Blessings
    {
        ...
        offers = {
            {
 		name = "Blueberry Cupcake", price = 100, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 31719, count = 1, icons = {"31719.png"}, description = "  use to fill all your mana points."},
			{name = "Blueberry Cupcake x3", price = 300, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 31719, count = 3, icons = {"31719.png"}, description = "  use to fill all your mana points."},		
			{name = "Tropical Fried Terrorbirds", price = 100, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 9995, count = 1, icons = {"Earthborn titan armor.png"}, description = "  use to boost your magic level by 5 for 1 hour.."},
	        {name = "Tropical Fried Terrorbirds x3", price = 300, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 9995, count = 3, icons = {"DTropical Fried Terrorbirds.png"}, description = "  use to boost your magic level by 5 for 1 hour.."},			
			{name = "Blessed Steaks", price = 160, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 9999, count = 1, icons = {"Blessed Steaks.png"}, description = "use to refill your entire mana points."},
	        {name = "Blessed Steaks x3", price = 480, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 9999, count = 3, icons = {"Blessed Steaks.png"}, description = "  use to refill your entire mana points."},			
			{name = "Carrot Cakes", price = 100, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 10000, count = 1, icons = {"Carrot Cakes.png"}, description = "  use to boost your distance fighting skill by 10 for 1 hour."},
	        {name = "Carrot Cakes x3", price = 300, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 10000, count = 3, icons = {"Carrot Cakes.png"}, description = "  use to boost your distance fighting skill by 10 for 1 hour."},			
			{name = "filled jalapeno pepperss", price = 100, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 9998, count = 1, icons = {"filled jalapeno pepperss.png"}, description = "  use to boost your speed by 100 levels for 1 hour."},
	        {name = "filled jalapeno pepperss x3", price = 300, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 9998, count = 3, icons = {"filled jalapeno pepperss.png"}, description = "  use to boost your speed by 100 levels for 1 hour."},			
			{name = "Hydra Tongue Salads", price = 100, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 9993, count = 1, icons = {"Hydra Tongue Salads.png"}, description = "  use to cure you of all negative conditions."},
	        {name = "Hydra Tongue Salads x3", price = 300, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 9993, count = 3, icons = {"Hydra Tongue Salads.png"}, description = "  use to cure you of all negative conditions."},			
			{name = "Lemon Cupcake", price = 100, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 31721, count = 1, icons = {"Lemon Cupcake.png"}, description = "  use to increase 10 distance fighting points by 1 hour."},
	        {name = "Lemon Cupcake x3", price = 300, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 31721, count = 3, icons = {"Lemon Cupcake.png"}, description = "  use to increase 10 distance fighting points by 1 hour."},			
			{name = "Northern Fishburger", price = 100, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 10001, count = 1, icons = {"Northern Fishburger.png"}, description = "  use to boost your fishing skill by 50 for 1 hour.."},
	        {name = "Northern Fishburger x3", price = 300, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 10001, count = 3, icons = {"Northern Fishburger.png"}, description = "  use to boost your fishing skill by 50 for 1 hour.."},			
			{name = "Pot of Blackjack", price = 80, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 12542, count = 1, icons = {"Pot of Blackjack.png"}, description = "  use to refill 5000 hit points."},
	        {name = "Pot of Blackjack x3", price = 240, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 12542, count = 3, icons = {"Pot of Blackjack.png"}, description = "  use to refill 5000 hit points."},			
			{name = "Roasted Dragon Wings", price = 100, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 9994, count = 1, icons = {"Roasted Dragon Wings.png"}, description = "  use to boost your shielding skill by 10 for 1 hour.."},
	        {name = "Roasted Dragon Wings x3", price = 300, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 9994, count = 3, icons = {"Roasted Dragon Wings.png"}, description = "  use to boost your shielding skill by 10 for 1 hour.."},			
			{name = "Rotworm Stew", price = 160, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 12542, count = 1, icons = {"Rotworm Stew.png"}, description = "  use to refill your entire hit points."},
	        {name = "Rotworm Stew x3", price = 280, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 12542, count = 3, icons = {"Rotworm Stew.png"}, description = "  use to refill your entire hit points."},			
			{name = "Strawberry Cupcake", price = 160, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 31720, count = 1, icons = {"Strawberry Cupcake.png"}, description = "  use to fill all your hit points.."},
	        {name = "Strawberry Cupcake x3", price = 480, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 31720, count = 3, icons = {"Strawberry Cupcake.png"}, description = "  use to fill all your hit points.."},
			{name = "Ceggie Casserole", price = 160, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 9997, count = 1, icons = {"Ceggie Casserole.png"}, description = "  use to boost your meele skills sword, axe and club fighting by 10 for 1 hour."},
	        {name = "Ceggie Casserole x3", price = 480, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 9997, count = 3, icons = {"Ceggie Casserole.png"}, description = "  use to boost your meele skills sword, axe and club fighting by 10 for 1 hour."
...
--imbuements
    {
        ...
        offers = {
            {
                ...
                itemtype = 12448, 
                items = {
                    {itemId = 12448, count = 25},
                    {itemId = 22534, count = 25},
			{itemId = 25386, count = 5},
                },
                type = GameStore.OfferTypes.OFFER_TYPE_ITEMS,
                price = 100,
        description = "Void \n 25 Rope Belts \n 25 Silencer Claws \n 5 Some Grimeleech Wings.",
                 	...
                 	-- Vampirism
			{
                ...
                itemtype = 10602, 
                items = {
                    {itemId = 10602, count = 25},
                    {itemId = 10550, count = 15},
			{itemId = 10580, count = 5},
                },
                type = GameStore.OfferTypes.OFFER_TYPE_ITEMS,
                price = 100,
        description = "Vampirism \n 25 Vampire Teeth \n 15 Bloody Pincerss \n 5 Piece of Dead Brain.",
			...
			-- Strike
			{
                icons = { "Basic_Strike.png" },
                name = "Strike",
                itemtype = 0, 
                items = {
                    {itemId = 12400, count = 20},
                    {itemId = 11228, count = 25},
			{itemId = 25384, count = 5},
                },
                type = GameStore.OfferTypes.OFFER_TYPE_ITEMS,
                price = 100,
        description = "Strike \n 20 protective charms \n 25 sabretooth \n 5 vexclaw talons.",
			...
			-- Lich Shroud
			{
                ...
                itemtype = 12422, 
                items = {
                    {itemId = 12422, count = 25},
                    {itemId = 24663, count = 20},
			{itemId = 10577, count = 5},
                },
                type = GameStore.OfferTypes.OFFER_TYPE_ITEMS,
                price = 100,
        description = "Lich Shroud \n 25 Flask of Embalming Fluid \n 20 Gloom Wolf Furs. \n 5 Mystical Hourglasses.",
        },
			-- Featherweight
			{
                icons = { "28999.png" },
                ...
                itemtype = 28999, 
                items = {
                    {itemId = 28999, count = 20},
                    {itemId = 29007, count = 10},
			{itemId = 22539, count = 5},
                },
                type = GameStore.OfferTypes.OFFER_TYPE_ITEMS,
                price = 100,
        description = "Featherweight \n 20 Fairy Wings \n 10 Little Bowl of Myrrhs \n 5 Goosebump Leather.",
        },
			-- Quara Scale
			{
                icons = { "11212.png" },
                ...
                itemtype = 11212, 
                items = {
                    {itemId = 11224, count = 25},
                    {itemId = 11228, count = 15},
			{itemId = 15425, count = 10},
                },
                type = GameStore.OfferTypes.OFFER_TYPE_ITEMS,
                price = 100,
        description = "Quara Scale \n 25 Winter Wolf Furs \n 15 Thick Furs. \n 5 Deepling Warts.",
        },
			-- Epiphany
			{
                icons = { "10552.png" },
                ...
                itemtype = 10552, 
                items = {
                    {itemId = 10552, count = 25},
                    {itemId = 12408, count = 15},
			{itemId = 11226, count = 15},
                },
                type = GameStore.OfferTypes.OFFER_TYPE_ITEMS,
                price = 100,
        description = "Epiphany \n 25 Elvish Talismans \n 15 Broken Shamanic Staffs \n 15 Strand of Medusa Hair.",
			...
			-- Frost
			{
                ...
                itemtype = 10578, 
                items = {
                    {itemId = 10578, count = 25},
                    {itemId = 24170, count = 10},
			{itemId = 10567, count = 10},
                },
                type = GameStore.OfferTypes.OFFER_TYPE_ITEMS,
                price = 100,
        description = "Frost \n 25 Frosty Hearts \n 10 Seacrest Hairs \n 10 Polar Bear Paws.",
			...
			-- Precision
			{
                ...
                itemtype = 12400, 
                items = {
                    {itemId = 12420, count = 25},
                    {itemId = 21311, count = 25},
			{itemId = 11215, count = 20},
                },
                type = GameStore.OfferTypes.OFFER_TYPE_ITEMS,
                price = 100,
        description = "Precision \n 25 Elven Scouting Glasss \n 25 Elven Hoofs \n 20 Metal Spikes.",
        },
			-- Scorch
			{
                icons = { "12400.png" },
        ...
        description = "Scorch \n 25 Fiery Hearts \n 5 Green Dragon Scales \n 5 Demon Horns.",
			...
			-- Swiftness
			{
                ...
                itemtype = 19738, 
                items = {
                    {itemId = 19738, count = 25},
                    {itemId = 11219, count = 25},
			{itemId = 15484, count = 20},
                },
                type = GameStore.OfferTypes.OFFER_TYPE_ITEMS,
                price = 100,
        description = "Swiftness \n 15 Damselfly Wings \n 25 Compasses \n 20 Waspoid Wings.",
			...
			-- Chop
			{
                ...
                itemtype = 11113, 
                items = {
                    {itemId = 11113, count = 20},
                    {itemId = 12403, count = 25},
			{itemId = 23571, count = 20},
                },
                type = GameStore.OfferTypes.OFFER_TYPE_ITEMS,
                price = 100,
        description = "Chop \n 20 Orc Tooth \n 25 Battle Stones \n 20 Moohtant Horns.",
			...
			-- Dragon Hide
			{
                ...
                itemtype = 5877, 
                items = {
                    {itemId = 5877, count = 20},
                    {itemId = 18425, count = 10},
			{itemId = 12614, count = 5},
                },
                type = GameStore.OfferTypes.OFFER_TYPE_ITEMS,
                price = 100,
        description = "Dragon Hide \n 20 Green Dragon Leathers \n 10 Blazing Bones \n 5 Draken Sulphurs.",
        },
			-- Slash
			{
                icons = { "10608.png" },
                ...
                itemtype = 10608, 
                items = {
                    {itemId = 10608, count = 25},
                    {itemId = 23573, count = 25},
			{itemId = 10571, count = 5},
                },
                type = GameStore.OfferTypes.OFFER_TYPE_ITEMS,
                price = 100,
        description = "Slash \n 25 Lion's Mane \n 25 Mooh'tah Shells \n 5 War Crystals.",
			...
			-- Snake Skin
			{
                ...
                itemtype = 20103, 
                items = {
                    {itemId = 20103, count = 25},
                    {itemId = 10611, count = 25},
			{itemId = 12658, count = 10},
                },
                type = GameStore.OfferTypes.OFFER_TYPE_ITEMS,
                price = 100,
        description = "Snake Skin \n 25 Piece of Swampling Wood \n 20 Snake Skins \n 10 Brimstone Fangss.",
			...
			-- Bash
			{
                ...
                itemtype = 10574, 
                items = {
                    {itemId = 10574, count = 20},
                    {itemId = 24845, count = 15},
			{itemId = 11322, count = 10},
                },
                type = GameStore.OfferTypes.OFFER_TYPE_ITEMS,
                price = 100,
        description = "Bash \n 20 Cyclops Toe \n 15 Ogre Nose Rings \n Warmaster's Wristguards.",
			...
			-- Blockade
			{
                ...
                itemtype = 10558, 
                items = {
                    {itemId = 10558, count = 20},
                    {itemId = 12659, count = 25},
			{itemId = 22533, count = 25},
                },
                type = GameStore.OfferTypes.OFFER_TYPE_ITEMS,
                price = 100,
        description = "Blockade \n 20 Piece of Scarab Shell \n 25 Brimstone Shells \n 25 Frazzle Skins.",
			...
			-- Cloud Fabric
			{
                ...
                itemtype = 10561, 
                items = {
                    {itemId = 10561, count = 20},
                    {itemId = 15482, count = 15},
			{itemId = 10582, count = 10},
                },
                type = GameStore.OfferTypes.OFFER_TYPE_ITEMS,
                price = 100,
        description = "Cloud Fabric \n 20 Wyvern Talismans \n 15 Crawler Head Platings \n 10 Wyrm Scales.",
        },
			-- Demon Presence
			{
                icons = { "10556.png" },
                ...
                itemtype = 10556, 
                items = {
                    {itemId = 10556, count = 25},
                    {itemId = 10555, count = 25},
			{itemId = 11221, count = 20},
                },
                type = GameStore.OfferTypes.OFFER_TYPE_ITEMS,
                price = 100,
        description = "Demon Presence \n 25 Cultish Robes \n 25 Cultish Masks \n 20 Hellspawn Tails.",
        },
			-- Electrify
			{
                icons = { "21310.png" },
                ...
                itemtype = 21310, 
                items = {
                    {itemId = 21310, count = 25},
                    {itemId = 24631, count = 5},
			{itemId = 26164, count = 1},
                },
                type = GameStore.OfferTypes.OFFER_TYPE_ITEMS,
                price = 100,
        description = "Electrify \n 25 rorc feathers \n 5 peacock feathers \n 1 energy vein.",
			...
			-- Reap
			{
                ...
                itemtype = 12440, 
                items = {
                    {itemId = 12440, count = 25},
                    {itemId = 10564, count = 20},
			{itemId = 11337, count = 5},
                },
                type = GameStore.OfferTypes.OFFER_TYPE_ITEMS,
                price = 100,
        description = "Reap \n 25 Pile of Grave Earth \n 20 Demonic Skeletal Hands \n 5 Petrified Screams.",
			...
			-- Venom
			{
                ...
                itemtype = 10603, 
                items = {
                    {itemId = 10603, count = 25},
                    {itemId = 10557, count = 20},
        ...
        description = "Venom \n 25 Swamp Grasses \n 20 Poisonous Slimes \n 2 Slime Hearts.",
			...
			-- Vibrancy
			{
                ...
                itemtype = 24709, 
                items = {
                    {itemId = 24709, count = 20},
                    {itemId = 26163, count = 15},
			{itemId = 33314, count = 5},
                },
                type = GameStore.OfferTypes.OFFER_TYPE_ITEMS,
                price = 100,
        description = "Vibrancy \n 20 Wereboar Hooves \n 15 Crystallized Angers \n 5 Quills.",
        },
    ...
    -- Kegs
    {
		...
		name = "green light", price = 100, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 23588, count = 1, icons = {"23588.png"}, description = "pronto."},
		{name = "major crystalline tokens", price = 90, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 18423, count = 1, icons = {"18423.png"}, description = "pronto."},
		{name = "major crystalline tokens x30", price = 250, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 18423, count = 30, icons = {"18423.png"}, description = "pronto."},
	    {name = "silver token", price = 425, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 25172, count = 100, icons = {"25172.png"}, description = "pronto."},
	    {name = "gold token x50", price = 300, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 25377, count = 50, icons = {"25377.png"}, description = "pronto."},
	        {name = "sneaky stabber of eliteness", price = 100, type = GameStore.OfferTypes.OFFER_TYPE_ITEM, itemtype = 10511, count = 1, icons = {"Wand of everblazing.png"}, description = "pronto."},
	        {name = "squeezing gear of girlpower", price = 100, type = GameStore.OfferTypes.OFFER_TYPE_ITEM, itemtype = 10513, count = 1, icons = {"10513.png"}, description = "pronto."},
	        {name = "whacking driller of fate", price = 100, type = GameStore.OfferTypes.OFFER_TYPE_ITEM, itemtype = 10515, count = 1, icons = {"10515.png"}, description = "pronto."
    ...
    -- Kegs
    {
        ...
        offers = {
            {
               name = "gold pouch", price = 400, type = GameStore.OfferTypes.OFFER_TYPE_ITEM, itemtype = 26377, count = 1, icons = {"gold pouch.png"}, description = "You can use it to store your money and etc.."},
	        {name = "jungle quiver", price = 80, type = GameStore.OfferTypes.OFFER_TYPE_ITEM, itemtype = 40359, count = 1, icons = {"jungle quiver.png"}, description = "pronto."},
   	        {name = "Zaoan chess box", price = 100, type = GameStore.OfferTypes.OFFER_TYPE_ITEM, itemtype = 20620, count = 1, icons = {"20620.png"}, description = "pronto."},
...
-- Cosmetics
 {
   ...
   name = "Cosmetics",
   rookgaard = true,
   subclasses = {"Mounts", "More Mounts", "Outfits", "Familiars"},
 },
...
icons = { "Category_Mounts.png" },
...

 {
   ...
   offers = { 
		...
		{
          icons = { "Rascoohan.png", "Rascoohan.png" },
          name = "Full Rascoohan",
          price = 300,
          sexId = {female = 1372, male = 1371},
          addon = 3,
          description = "{character}\n{info} colours can be changed using the Outfit dialog\n\n<i>Rascoohan is all geared up for a tournament, ready to partake in festive activities involving friendly competition to prove their chivalry. However, being well-armoured, they are also a force to be reckoned with on the battlefield, especially with a trusty steed at their service.</i>",
          type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT,
        },
		{
          icons = { "mouthcape.png", "mouthcape.png" },
          name = "Full Mouth Cape",
          price = 300,
          sexId = {female = 1339, male = 1338},
          addon = 3,
          description = "{character}\n{info} colours can be changed using the Outfit dialog\n\n<i>Mouthcape is all geared up for a tournament, ready to partake in festive activities involving friendly competition to prove their chivalry. However, being well-armoured, they are also a force to be reckoned with on the battlefield, especially with a trusty steed at their service.</i>",
          type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT,
        },
        {
          icons = { "goldenmale.png", "goldenfemale.png" },
          name = "Golden",
          price = 4000,
          sexId = {female = 1211, male = 1210},
          addon = 3,
          description = "{character}\n{info} colours can be changed using the Outfit dialog\n\n<i>Golden is all geared up for a tournament, ready to partake in festive activities involving friendly competition to prove their chivalry. However, being well-armoured, they are also a force to be reckoned with on the battlefield, especially with a trusty steed at their service.</i>",
          type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT,
        },
        {
...
icons = { "Category_Mounts.png" },
   ...
   offers = { 
        {
          icons = { "Bladespark.png" },
          name = "BladeSpark",
          price = 400,
          vocations = {1, 5},
          sexId = {female = 1367, male = 1367},
          description = "Sorcerer Familiar",
          type = GameStore.OfferTypes.OFFER_TYPE_FAMILIAR,
        },
        {
          icons = { "Mossmasher.png" },
          name = "Mossmasher",
          price = 400,
          vocations = {2, 6},
          sexId = {female = 1364, male = 1364},
          description = "Druid Familiar",
          type = GameStore.OfferTypes.OFFER_TYPE_FAMILIAR,
        },        
{
          icons = { "Sandscourge.png" },
          name = "Sandscourge",
          price = 400,
          vocations = {3, 7},
          sexId = {female = 1366, male = 1366},
          description = "Paladin Familiar",
          type = GameStore.OfferTypes.OFFER_TYPE_FAMILIAR,
        },        
	{
          icons = { "Snowbash.png" },
          ...
          price = 400,
          vocations = {4, 8},
          sexId = {female = 1365, male = 1365},
          description = "Knight Familiar",
          type = GameStore.OfferTypes.OFFER_TYPE_FAMILIAR,
        },      
},
   rookgaard = true,
   ...
   name = "Houses",
   rookgaard = true,
   subclasses = {"Exclusive Offers", "House", "Decorations", "Objects", "Great Objects", "More Items", "Last Items"},
  },
  -- Tickets
	{
