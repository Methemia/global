...
HomeBanners = {
   images = {"home/doble_exp_3.png", "home/banner_runemaster.png", "home/banner_podiumofrenown.png"},
   delay = 10
}
...
GameStore.Categories = {
    {
        ...
        offers = {
            {name = "Temple Teleport", count = 1, type = GameStore.OfferTypes.OFFER_TYPE_TEMPLE, price = 7, icons = {"Temple_Teleport.png"}, description = "Teleports you instantly to your home temple."},	
			...
			{name = "Character Name Change", type = GameStore.OfferTypes.OFFER_TYPE_NAMECHANGE, price = 125, icons = {"Name_Change.png"}, description = "Change your name."},
			{name = "Character Sex Change", type = GameStore.OfferTypes.OFFER_TYPE_SEXCHANGE, price = 80, icons = {"Sex_Change.png"}, description = "Change your sex."},
			...
			{name = "Charm Expansion", type = GameStore.OfferTypes.OFFER_TYPE_CHARMS, price = 400, id = 65005, icons = {"Charm_Expansion_Offer.png"}, description = "charm expansion."},
			{name = "Prey Bonus Reroll", count = 1, type = GameStore.OfferTypes.OFFER_TYPE_PREYBONUS, price = 3, icons = {"Prey_Bonus_Reroll.png"}, description = "Prey re roll."},
			{name = "Prey Bonus Reroll x90", count = 90, type = GameStore.OfferTypes.OFFER_TYPE_PREYBONUS, price = 270, icons = {"Prey_Bonus_Reroll.png"}, description = "Prey re roll."},
    ...
    },
    {
        ...
        state = GameStore.States.STATE_NONE,
        offers = {
	{name = "Bag you desire", price = 1800, type = GameStore.OfferTypes.OFFER_TYPE_ITEM, itemtype = 38944, count = 1, icons = {"38944.png"}, description = "Random Soul Item."},
        ...
        {name = "Stamina Refill - 2 hours", price = 100, type = GameStore.OfferTypes.OFFER_TYPE_ITEM, itemtype = 38763, count = 1, icons = {"38763.png"}, description = "Regenera 2 horas de stamina."},
        ...
        {name = "Autoloot Manager", price = 2500, type = GameStore.OfferTypes.OFFER_TYPE_ITEM, itemtype = 7731, count = 1, icons = {"38944.png"}, description = "Autoloot Manager es un autoloot que lotea sin necesidad de dar click, solo necesitas utilizar el item sobre el objeto que quieres añadir a la lista y el autoloot hara el resto."},
...
icons = {"Exercise_Club.png"},
  ...
  icons = {"Exercise_Sword.png"},
   ...
   description = "<i>Use it to train your axe fighting skill on an exercise dummy!</i>\n\n{character}\n{storeinbox}\n{info} use it on an exercise dummy to train your axe fighting skill\n{info} usable 5500 times a piece",
                type = GameStore.OfferTypes.OFFER_TYPE_CHARGES},
...
icons = {"Exercise_Club.png"},
 ...
 icons = {"Exercise_Wand.png"},
                ...
                charges = 28800,
icons = {"Exercise_Axe.png"},
                description = "<i>Use it to train your axe fighting skill on an exercise dummy!</i>\n\n{character}\n{storeinbox}\n{info} use it on an exercise dummy to train your axe fighting skill\n{info} usable 28800 times a piece",
                type = GameStore.OfferTypes.OFFER_TYPE_CHARGES},
...
icons = {"Exercise_Sword.png"},
    ...
    -- Blessings
    {
        ...
        offers = {
            {
 		name = "Blueberry Cupcake", price = 50, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 31719, count = 1, icons = {"31719.png"}, description = "  use to fill all your mana points."},
			{name = "Blueberry Cupcake x3", price = 150, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 31719, count = 3, icons = {"31719.png"}, description = "  use to fill all your mana points."},		
			{name = "Tropical Fried Terrorbirds", price = 50, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 9995, count = 1, icons = {"Earthborn titan armor.png"}, description = "  use to boost your magic level by 5 for 1 hour.."},
	        {name = "Tropical Fried Terrorbirds x3", price = 150, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 9995, count = 3, icons = {"DTropical Fried Terrorbirds.png"}, description = "  use to boost your magic level by 5 for 1 hour.."},			
			{name = "Blessed Steaks", price = 80, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 9999, count = 1, icons = {"Blessed Steaks.png"}, description = "use to refill your entire mana points."},
	        {name = "Blessed Steaks x3", price = 240, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 9999, count = 3, icons = {"Blessed Steaks.png"}, description = "  use to refill your entire mana points."},			
			{name = "Carrot Cakes", price = 50, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 10000, count = 1, icons = {"Carrot Cakes.png"}, description = "  use to boost your distance fighting skill by 10 for 1 hour."},
	        {name = "Carrot Cakes x3", price = 150, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 10000, count = 3, icons = {"Carrot Cakes.png"}, description = "  use to boost your distance fighting skill by 10 for 1 hour."},			
			{name = "filled jalapeno pepperss", price = 50, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 9998, count = 1, icons = {"filled jalapeno pepperss.png"}, description = "  use to boost your speed by 100 levels for 1 hour."},
	        {name = "filled jalapeno pepperss x3", price = 150, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 9998, count = 3, icons = {"filled jalapeno pepperss.png"}, description = "  use to boost your speed by 100 levels for 1 hour."},			
			{name = "Hydra Tongue Salads", price = 50, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 9993, count = 1, icons = {"Hydra Tongue Salads.png"}, description = "  use to cure you of all negative conditions."},
	        {name = "Hydra Tongue Salads x3", price = 150, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 9993, count = 3, icons = {"Hydra Tongue Salads.png"}, description = "  use to cure you of all negative conditions."},			
			{name = "Lemon Cupcake", price = 50, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 31721, count = 1, icons = {"Lemon Cupcake.png"}, description = "  use to increase 10 distance fighting points by 1 hour."},
	        {name = "Lemon Cupcake x3", price = 150, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 31721, count = 3, icons = {"Lemon Cupcake.png"}, description = "  use to increase 10 distance fighting points by 1 hour."},			
			{name = "Northern Fishburger", price = 50, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 10001, count = 1, icons = {"Northern Fishburger.png"}, description = "  use to boost your fishing skill by 50 for 1 hour.."},
	        {name = "Northern Fishburger x3", price = 150, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 10001, count = 3, icons = {"Northern Fishburger.png"}, description = "  use to boost your fishing skill by 50 for 1 hour.."},			
			{name = "Pot of Blackjack", price = 40, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 12542, count = 1, icons = {"Pot of Blackjack.png"}, description = "  use to refill 5000 hit points."},
	        {name = "Pot of Blackjack x3", price = 120, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 12542, count = 3, icons = {"Pot of Blackjack.png"}, description = "  use to refill 5000 hit points."},			
			{name = "Roasted Dragon Wings", price = 50, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 9994, count = 1, icons = {"Roasted Dragon Wings.png"}, description = "  use to boost your shielding skill by 10 for 1 hour.."},
	        {name = "Roasted Dragon Wings x3", price = 150, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 9994, count = 3, icons = {"Roasted Dragon Wings.png"}, description = "  use to boost your shielding skill by 10 for 1 hour.."},			
			{name = "Rotworm Stew", price = 80, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 12542, count = 1, icons = {"Rotworm Stew.png"}, description = "  use to refill your entire hit points."},
	        {name = "Rotworm Stew x3", price = 240, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 12542, count = 3, icons = {"Rotworm Stew.png"}, description = "  use to refill your entire hit points."},			
			{name = "Strawberry Cupcake", price = 80, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 31720, count = 1, icons = {"Strawberry Cupcake.png"}, description = "  use to fill all your hit points.."},
	        {name = "Strawberry Cupcake x3", price = 240, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 31720, count = 3, icons = {"Strawberry Cupcake.png"}, description = "  use to fill all your hit points.."},
			{name = "Ceggie Casserole", price = 80, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 9997, count = 1, icons = {"Ceggie Casserole.png"}, description = "  use to boost your meele skills sword, axe and club fighting by 10 for 1 hour."},
	        {name = "Ceggie Casserole x3", price = 240, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 9997, count = 3, icons = {"Ceggie Casserole.png"}, description = "  use to boost your meele skills sword, axe and club fighting by 10 for 1 hour."
...
--imbuements
    ...
    -- Kegs
    {
		...
		name = "green light", price = 50, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 23588, count = 1, icons = {"23588.png"}, description = "pronto."},
		{name = "major crystalline tokens", price = 90, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 18423, count = 10, icons = {"18423.png"}, description = "pronto."},
