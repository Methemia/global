...
GameStore.Categories = {
    ...
    -- Blessings
    {
        ...
        offers = {
            {
                name = "Temple Teleport", count = 1, type = GameStore.OfferTypes.OFFER_TYPE_TEMPLE, price = 100, icons = {"Temple_Teleport.png"}, description = "Teleports you instantly to your home temple."},	
			...
			{name = "XP Boost 50% (1 hora)", type = GameStore.OfferTypes.OFFER_TYPE_EXPBOOST, price = 150, home = true, icons = {"XP_Boost.png"}, description = "Bonus experience."},
			...
			{name = "Prey Bonus Reroll x5", count = 5, type = GameStore.OfferTypes.OFFER_TYPE_PREYBONUS, price = 75, icons = {"Prey_Bonus_Reroll.png"}, description = "Prey re roll."},
			{name = "Prey Bonus Reroll x20", count = 20, type = GameStore.OfferTypes.OFFER_TYPE_PREYBONUS, price = 120, icons = {"Prey_Bonus_Reroll.png"}, description = "Prey re roll."},
			{name = "Permanent Prey Slot", id = 65008, type = GameStore.OfferTypes.OFFER_TYPE_PREYSLOT, price = 500, icons = {"Permanent_Prey_Slot.png"}, description = "last Prey slot."},
        		{name = "Time Waster", price = 1800, type = GameStore.OfferTypes.OFFER_TYPE_ITEM, itemtype = 27631, count = 1, icons = {"27631.png"}, description = "{info} Faster Regeneration HP \n{activated}\n{info} 25 hp per second\n{info} Critical 2%\n {info} Critical chance 1%\n"},
       			{name = "Boss Timer", price = 800, type = GameStore.OfferTypes.OFFER_TYPE_ITEM, itemtype = 18526, count = 1, icons = {"18526.png"}, description = "Boss timer - Es un objeto que te indica el tiempo en el que se desbloquearan los bosses"},
       			{name = "Small Stamina Refill", price = 150, type = GameStore.OfferTypes.OFFER_TYPE_ITEM, itemtype = 41563, count = 1, icons = {"41563.png"}, description = "Regenera 6 horas de tu stamina."},
			{name = "Stamina Refill", price = 500, type = GameStore.OfferTypes.OFFER_TYPE_ITEM, itemtype = 41560, count = 1, icons = {"38944.png"}, description = "Regenera toda tu stamina."},
    ...
    -- Blessings
    {
      ...
      {name = "Spellbook of Ancient Arcana", price = 275, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 16112, count = 1, icons = {"16112.png"}, description = "proximamente"},
      {name = "Crude Umbral Spellbook", price = 225, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 22422, count = 1, icons = {"22424.png"}, description = "proximamente"},
      {name = "Hat of the mad", price = 225, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 2323, count = 1, icons = {"2323.png"}, description = "proximamente"},
      {name = "Oriental shoes", price = 125, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 24637, count = 1, icons = {"24637.png"}, description = "proximamente"},
      {name = "Royal scale robe", price = 225, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 12643, count = 1, icons = {"12643.png"}, description = "proximamente"},
    ...
    -- Blessings
    {
        ...
        offers = {
      		     ...
      		     {name = "Depth lorica", price = 275, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 15407, count = 1, icons = {"15407.png"}, description = "proximamente"},
      		     {name = "Dwarven legs", price = 275, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 2504, count = 1, icons = {"2504.png"}, description = "proximamente"},
      		     {name = "Elite draken helmet", price = 275, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 12645, count = 1, icons = {"12645.png"}, description = "proximamente"},
      		     {name = "Master archers armor", price = 275, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 8888, count = 1, icons = {"30691.png"}, description = "proximamente"},
      		     {name = "Prismatic armor", price = 175, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 18404, count = 1, icons = {"30691.png"}, description = "proximamente"},
      		     {name = "Prismatic boots", price = 175, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 18406, count = 1, icons = {"30691.png"}, description = "proximamente"},
      		     {name = "Prismatic legs", price = 175, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 18405, count = 1, icons = {"18405.png"}, description = "proximamente"},
      		     {name = "Rift bow", price = 325, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 25522, count = 1, icons = {"25522.png"}, description = "proximamente"},
      		     {name = "Royal crossbow", price = 225, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 8851, count = 1, icons = {"8851.png"}, description = "proximamente"},
      		     {name = "Zaoan helmet", price = 125, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 11302, count = 1, icons = {"11302.png"}, description = "proximamente"},
    ...
    -- Blessings
    {
        ...
        offers = {
     		     ...
     		     {name = "Slayer of Destruction", price = 275, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 30685, count = 1, icons = {"30685.png"}, description = "proximamente"},
      		     {name = "Prismatic armor", price = 125, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 18404, count = 1, icons = {"30691.png"}, description = "proximamente"},
      		     {name = "Dwarven legs", price = 275, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 2504, count = 1, icons = {"2504.png"}, description = "proximamente"},
      		     {name = "Prismatic helmet", price = 175, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 18403, count = 1, icons = {"18403.png"}, description = "proximamente"},
      		     {name = "Prismatic shield", price = 175, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 18410, count = 1, icons = {"18410.png"}, description = "proximamente"},
      		     {name = "Royal draken mail", price = 275, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 12642, count = 1, icons = {"12642.png"}, description = "proximamente"},
      		     {name = "Zaoan helmet", price = 125, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 11302, count = 1, icons = {"11302.png"}, description = "proximamente"},
      		     {name = "Solar axe", price = 400, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 8925, count = 1, icons = {"8925.png"}, description = "proximamente"},
      		     {name = "the ephipany", price = 400, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 8931, count = 1, icons = {"8931.png"}, description = "proximamente"},
      		     {name = "the stomper", price = 400, type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, itemtype = 8929, count = 1, icons = {"8929.png"}, description = "proximamente"},
...
-----
   ...
   name = "Tournament",
   rookgaard = true,
   subclasses = {"Tickets", "Exclusive Tournament Offers"},
  },
  -- Tickets
	{
   icons = { "Category_Tickets.png" },
 ...
 -- Exclusive Offers  
      ...
      icons = { "Category_ExclusiveOffers.png" },
      name = "Exclusive Tournament Offers",
      parent = "Tournament", 
      rookgaard = true,
      state = GameStore.States.STATE_NONE,
      offers = {
