...
GameStore.Categories = {
	{
		...
		offers = {
			...
			{name = "Stamina refill - 2 hours", itemtype = 38763, count = 1, type = GameStore.OfferTypes.OFFER_TYPE_ITEM, price = 25, icons = {"Bottle_of_Tibian_Wine.png"}, description = "2 hours stamina."},
			...
			{name = "Addon Doll", price = 60, type = GameStore.OfferTypes.OFFER_TYPE_ITEM, itemtype = 24807, count = 1, icons = {"24807.png"}, description = "1 Addon."},
			{name = "Character Name Change", type = GameStore.OfferTypes.OFFER_TYPE_NAMECHANGE, price = 100, icons = {"Name_Change.png"}, description = "Change your name."},
			{name = "Character Sex Change", type = GameStore.OfferTypes.OFFER_TYPE_SEXCHANGE, price = 50, icons = {"Sex_Change.png"}, description = "Change your sex."},
