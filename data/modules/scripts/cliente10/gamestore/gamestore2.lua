...
GameStore.Categories = {
	{
		name = "Extra Services/Useful Things",
		state = GameStore.States.STATE_NONE,
		rookgaard = false,
		icons = {"Category_PremiumTime.png"},
		offers = {
			--{name = "Scroll 30 Days of Vip Time", itemtype = 16101, count = 1, type = GameStore.OfferTypes.OFFER_TYPE_ITEM, price = 30, icons = {"PremiumScroll.png"}, description = "Ao usar este Vip Scroll sua account recebe 30 dias vip. E para sua comodidade, você pode usar quantos Vip Scroll quiser que os dias vips vão sendo somados."},
			...
			{name = "Stamina refill - 2 hours", itemtype = 38765, count = 1, type = GameStore.OfferTypes.OFFER_TYPE_ITEM, price = 25, icons = {"Bottle_of_Tibian_Wine.png"}, description = "2 hours stamina."},
			...
			{name = "Remover Skull", itemtype = 9969, type = GameStore.OfferTypes.OFFER_TYPE_ITEM, price = 70, icons = {"blackskull.png"}, description = "Remover Skull"},
			...
			{name = "Character Name Change", type = GameStore.OfferTypes.OFFER_TYPE_NAMECHANGE, price = 100, icons = {"Name_Change.png"}, description = "pronto."},
			{name = "Character Sex Change", type = GameStore.OfferTypes.OFFER_TYPE_SEXCHANGE, price = 50, icons = {"Sex_Change.png"}, description = "pronto."},
			{name = "XP Boost 50% (1 hora)", type = GameStore.OfferTypes.OFFER_TYPE_EXPBOOST, price = 60, icons = {"XP_Boost.png"}, description = "pronto."},
			{name = "Charm Expansion", type = GameStore.OfferTypes.OFFER_TYPE_CHARMS, price = 100, id = 65005, icons = {"Charm_Expansion_Offer.png"}, description = "pronto."},
			{name = "25x Prey Bonus Reroll", count = 25, type = GameStore.OfferTypes.OFFER_TYPE_PREYBONUS, price = 30, icons = {"Prey_Bonus_Reroll.png"}, description = "pronto."},
			{name = "Permanent Prey Slot", id = 65008, type = GameStore.OfferTypes.OFFER_TYPE_PREYSLOT, price = 100, icons = {"Permanent_Prey_Slot.png"}, description = "pronto."},

			--{name = "Auto Loot Gold", type = GameStore.OfferTypes.OFFER_TYPE_AUTOLOOT_GOLD, price = 100, icons = {"Product_UsefulThings_PermanentPreySlot.png"}, description = "pronto."},
			--{name = "Auto Loot Increase +1", slotIncrease = 1, storageAmount = 29999, maxPurchase = 100, type = GameStore.OfferTypes.OFFER_TYPE_AUTOLOOT_SLOTS, price = 10, icons = {"Product_UsefulThings_PermanentPreySlot.png"}, description = "pronto."},
...
icons = {"Exercise_Wand.png"},
 ...
 -- Exclusive Offers  
	...
	},
	{
								...
								name = "Weapons - Knight",
		state = GameStore.States.STATE_NONE,
		description = "Buy an item and further improve its journey within our server.",
		rookgaard = false,
		icons = {"Items.png"},
		offers = {
	...
	},
	{
		...
		rookgaard = true,
		offers = {
			{name = "Retro Citizen", sexId = {male = 974, female = 975}, type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT, price = 50, icons = {"Product_Outfit_RetroCitizen_Male_Base.png", "Product_Outfit_RetroCitizen_Female_Base.png"}, description = "pronto."},
			{name = "Retro Hunter", sexId = {male = 972, female = 973}, type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT, price = 50, icons = {"Product_Outfit_RetroHunter_Male_Base.png", "Product_Outfit_RetroHunter_Female_Base.png"}},
			{name = "Retro Knight", sexId = {male = 970, female = 971}, type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT, price = 50, icons = {"Product_Outfit_RetroKnight_Male_Base.png", "Product_Outfit_RetroKnight_FemaleFix_Base.png"}, description = "pronto."},
			{name = "Retro Wizzard", sexId = {male = 968, female = 969}, type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT, price = 50, icons = {"Product_Outfit_RetroMage_Male_Base.png", "Product_Outfit_RetroMage_Female_Base.png"}, description = "pronto."},
			{name = "Retro Noblewoman", sexId = {male = 966, female = 967}, type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT, price = 50, icons = {"Product_Outfit_RetroNobleman_Male_Base.png", "Product_Outfit_RetroNobleman_Female_Base.png"}, description = "pronto."},
			{name = "Retro Summoner", sexId = {male = 964, female = 965}, type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT, price = 50, icons = {"Product_Outfit_RetroSummoner_Male_Base.png", "Product_Outfit_RetroSummoner_Female_Base.png"}, description = "pronto."},
			{name = "Retro Warrior", sexId = {male = 962, female = 963}, type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT, price = 50, icons = {"Product_Outfit_RetroWarrior_Male_Base.png", "Product_Outfit_RetroWarrior_Female_Base.png"}, description = "pronto."},
			{name = "Full Arena Champion Outfit", sexId = { male = 884, female = 885 }, addon = 3, type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT, price = 50, icons = {"Product_Outfit_ArenaChampion_Male_Full.png", "Product_Outfit_ArenaChampion_Female_Full.png"}, description = "pronto."},
		    {name = "Full Philosopher Outfit", sexId = {male = 873, female = 874}, addon = 3, type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT, price = 50, icons = {"Product_Outfit_Professor_Male_Full.png", "Product_Outfit_Professor_Female_Full.png"}, description = "pronto."},
			{name = "Full Winter Warden Outfit", sexId = {male = 853, female = 852}, addon = 3, type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT, price = 50,  icons = {"Product_Outfit_WinterWarden_Male_Full.png", "Product_Outfit_WinterWarden_Female_Full.png"}, description = "pronto."},
		  	  {name = "Full Royal Pumpkin Outfit", sexId = {male = 760, female = 759}, addon = 3, type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT, price = 50, icons = {"Product_Outfit_RoyalPumpkin_Male_Full.png", "Product_Outfit_RoyalPumpkin_Female_Full.png"}, description = "pronto."},
			{name = "Full Sea Dog Outfit", sexId = {male = 750, female = 749}, addon = 3, type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT, price = 50, icons = {"Product_Outfit_SeaDog_Male_Full.png", "Product_Outfit_SeaDog_Female_Full.png"}, description = "pronto."},
			{name = "Full Champion Outfit", sexId = {male = 633, female = 632}, addon = 3, type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT, price = 50, icons = {"Product_Outfit_Champion_Male_Full.png", "Product_Outfit_Champion_Female_Full.png"}, description = "pronto."},
			{name = "Full Conjurer Outfit", sexId = {male = 634, female = 635}, addon = 3, type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT, price = 50, icons = {"Product_Outfit_Conjurer_Male_Full.png", "Product_Outfit_Conjurer_Female_Full.png"}, description = "pronto."},
			{name = "Full Beastmaster Outfit", sexId = {male = 637, female = 636}, addon = 3, type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT, price = 50, icons = {"Product_Outfit_Beastmaster_Male_Full.png", "Product_Outfit_Beastmaster_Female_Full.png"}, description = "pronto."},
			{name = "Full Chaos Acolyte Outfit", sexId = {male = 665, female = 664}, addon = 3, type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT, price = 50, icons = {"Product_Outfit_ChaosAcolyte_Male_Full.png", "Product_Outfit_ChaosAcolyte_Female_Full.png"}, description = "pronto."},
			{name = "Full Death Herald Outfit", sexId = {male = 667, female = 666}, addon = 3, type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT, price = 50, icons = {"Product_Outfit_DeathHerald_Male_Full.png", "Product_Outfit_DeathHerald_Female_Full.png"}, description = "pronto."},
			{name = "Full Ranger Outfit", sexId = {male = 684, female = 683}, addon = 3, type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT, price = 50, icons = {"Product_Outfit_Ranger_Male_Full.png", "Product_Outfit_Ranger_Female_Full.png"}, description = "pronto."},
			{name = "Full Ceremonial Garb Outfit", sexId = {male = 695, female = 694}, addon = 3, type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT, price = 50, icons = {"Product_Outfit_CeremonialGarb_Male_Full.png", "Product_Outfit_CeremonialGarb_Female_Full.png"}, description = "pronto."},
			{name = "Full Puppeteer Outfit", sexId = {male = 697, female = 696}, addon = 3, type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT, price = 50, icons = {"Product_Outfit_Puppeteer_Male_Full.png", "Product_Outfit_Puppeteer_Female_Full.png"}, description = "pronto."},
			{name = "Full Spirit Caller Outfit", sexId = {male = 699, female = 698}, addon = 3, type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT, price = 50, icons = {"Product_Outfit_SpiritCaller_Male_Full.png", "Product_Outfit_SpiritCaller_Female_Full.png"}, description = "pronto."},
			{name = "Full Evoker Outfit", sexId = {male = 725, female = 724}, addon = 3, type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT, price = 50, icons = {"Product_Outfit_Evoker_Male_Full.png", "Product_Outfit_Evoker_Female_Full.png"}, description = "pronto."},
			{name = "Full Seaweaver Outfit", sexId = {male = 733, female = 732}, addon = 3, type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT, price = 50, icons = {"Product_Outfit_SeaWeaver_Male_Full.png", "Product_Outfit_SeaWeaver_Female_Full.png"}, description = "pronto."},
			{name = "Full Pharaoh Outfit", sexId = {male = 955, female = 956}, addon = 3, type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT, price = 50, icons = {"Product_Outfit_Pharaoh_female_Full.png", "Product_Outfit_Pharaoh_female_Full.png"}, description = "pronto."},
			{name = "Full Hunter", sexId = {male = 129, female = 137}, addon = 3, type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT, price = 50, icons = {"Hunteramle.png", "Hunterfemale.png"}, description = "pronto."},
			{name = "Full Warrior", sexId = {male = 134, female = 142}, addon = 3, type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT, price = 50, icons = {"Warriormale.png", "Warriorfemale.png"}, description = "pronto."},
			{name = "Full Barbarian", sexId = {male = 143, female = 147}, addon = 3, type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT, price = 50, icons = {"Barbarianmale.png", "Barbarianfemale.png"}, description = "pronto."},
			{name = "Full Druid", sexId = {male = 144, female = 148}, addon = 3, type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT, price = 50, icons = {"Druidmale.png", "Druidfemale.png"}, description = "pronto."},
			{name = "Full Assassin", sexId = {male = 152, female = 156}, addon = 3, type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT, price = 50, icons = {"Assassinmale.png", "Assassinfemale.png"}, description = "pronto."},
   			    {name = "Full Elementalist", sexId = {male = 432, female = 433}, addon = 3, type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT, price = 50, icons = {"magemale.png", "magefemale.png"}, description = "pronto."},
   ...
   name = "Client 12",
   rookgaard = true,
   subclasses = {"Exclusive Offers", "Houses", "Decorations"},
  },
  -- Tickets
	{
   icons = { "Category_Tickets.png" },
