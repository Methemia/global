exerciseWeaponsTable = {
	-- MELE
	[32124] = { skill = SKILL_SWORD, effect = CONST_ANI_SMALLICE, allowFarUse = true },
	[32384] = { skill = SKILL_SWORD, effect = CONST_ANI_SMALLICE, allowFarUse = true },
	[40114] = { skill = SKILL_SWORD, effect = CONST_ANI_SMALLICE, allowFarUse = true },
	[40120] = { skill = SKILL_SWORD, effect = CONST_ANI_SMALLICE, allowFarUse = true },
	[32385] = { skill = SKILL_AXE, effect = CONST_ANI_SMALLICE, allowFarUse = true },
	[32125] = { skill = SKILL_AXE, effect = CONST_ANI_SMALLICE, allowFarUse = true },
	[40115] = { skill = SKILL_AXE, effect = CONST_ANI_SMALLICE, allowFarUse = true },
	[40121] = { skill = SKILL_AXE, effect = CONST_ANI_SMALLICE, allowFarUse = true },
	[32386] = { skill = SKILL_CLUB, effect = CONST_ANI_SMALLICE, allowFarUse = true },
	[32126] = { skill = SKILL_CLUB, effect = CONST_ANI_SMALLICE, allowFarUse = true },
	[40116] = { skill = SKILL_CLUB, effect = CONST_ANI_SMALLICE, allowFarUse = true },
	[40122] = { skill = SKILL_CLUB, effect = CONST_ANI_SMALLICE, allowFarUse = true },
	-- ROD
