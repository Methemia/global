...
Storage = {
	...
	ThreatenedDreams = {
		...
		FinalMission = 35053, -- -1 no inicio/ 1 tiene que matar los bichos y al jefe / 2 liberar las hadas (puede recoger el dark moon) / 3 debe llenar de "poder" (puede obtener los otros 2 items) / 4 usar 15 en total los items / 5 termino todo
		MiniRoshaCounter = 35054,
		KroazurKilled = 35055,
		FairyFreeCount = 35079,
		FairyFree1 = 35056,
		FairyFree2 = 35057,
		FairyFree3 = 35058,
		FairyFree4 = 35059,
		...
		RewardFinal1 = 35061,
		RewardFinal2 = 35062,
		StoneMosaicCounter = 35080,
		StoneMosaic1 = 35063,
		StoneMosaic2 = 35064,
		StoneMosaic3 = 35065,
		StoneMosaic4 = 35066,
		StoneMosaic5 = 35067,
		DreamBirdTreeCounter = 35081,
		DreamBirdTree1 = 35068,
		DreamBirdTree2 = 35069,
		DreamBirdTree3 = 35070,
		DreamBirdTree4 = 35071,
		DreamBirdTree5 = 35072,
		MoonSculptureCounter = 35082,
		MoonSculpture1 = 35073,
		MoonSculpture2 = 35074,
		MoonSculpture3 = 35075,
		MoonSculpture4 = 35076,
		MoonSculpture5 = 35077,
		RewardFinal3 = 35078,
		SwanFeatherCloak1 = 35083,
        SwanFeatherCloak2 = 35084,
        SwanFeatherCloak3 = 35085,
        SwanFeatherCloak4 = 35086,
        SwanFeatherCloak5 = 35087,
        SwanFeatherCloak6 = 35088,
        SwanFeatherCloak7 = 35089,
        SwanFeatherCloak8 = 35090,
        TotalSwanFeathers = 35091,
        WaitingTime = 35092,
        ReceivedFeatherCloak = 35093
	},
	FirstDragon = {
...
Tibiana = {
		-- Reserved storage from 90520 - 90550
		ScarlettTimer = 90520,
		OberonTimer = 90521,
		UrmaTimer = 90522,
		DukeKruleTimer = 90523,
		SirNictrosTimer = 90524,
		CounVlarkorthTimer = 90525,
		EarlOsamTimer = 90526,
		LordAzaramTimer = 90527,
		FacelessBaneTimer = 90528,
		DreamTimer = 90529,
		BloodbackTimer = 90530,
		DarkfangTimer = 90531,
		SharpclawTimer = 90532,
		BlackVixenTimer = 90533,
		ShadowPeltTimer = 90534,
		EthershreckTimer = 90535,
		KingZelosTimer = 90536,
		UnazTheMeanTimer = 90537,
		IrgixTheFlimsyTimer = 90538,
		VokTheFreakishTimer = 90539,
		BrainHeadTimer = 90540,
		LokathmorTimer = 90541,
		MazzinorTimer = 90542,
		GhuloshTimer = 90543,		
		GorzindelTimer = 90544,
		TheArmoredVoidbornTimer = 90545,
		LloydTimer = 90546,
		TheSandKingTimer = 90547,
		TheNightmareBeastTimer = 90548,
		DrumeTimer = 90549,
		FugueTimer = 90550,
	...
	DreamCourts = {
		-- Reserved storage from 63500 - 63520
		Questline = 63500,
		FacelessBane = {
			Questline = 63501,
			FacelessTimer = 63502
		...
		DreamMaxxenius = {
			Questline = 63511,
			MaxxeniusTimer = 63512
		},
		Questline = 63513,
		DreamPlagueroot = {
			Questline = 63514,
			PlaguerootTimer = 63515
		},
		Questline = 63516,
		NightmareBeast = {
			Questline = 63517,
			NightmareTimer = 63518
		}
	},
	FeasterOfSouls = {
		Questline = 90555,
		...
		TheUnwelcome = {
			Questline = 90565,
			UnwelcomeTimer = 90566
		},
		Questline = 90567,
		BrainHead = {
			Questline = 90568,
			BrainHeadTimer = 90569
		}
	},
	PiratsTails = {
		Questline = 90600,
