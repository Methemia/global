...
CONFIG_GUILD_LEVEL = {
	...
	maxLevel = 20, -- guild level limit
	minLevelToGetPoints = 150,
	rewards = {-- level, type of the reward and bonus quantity
		[1] = {level = 1, type = nil, quantity = nil},
		[2] = {level = 2, type = GUILD_LEVEL_BONUS_EXP, quantity = 0.02},-- 2% XP
		[3] = {level = 3, type = GUILD_LEVEL_BONUS_LOOT, quantity = 0.02}, -- 2% LOOT
		[4] = {level = 4, type = GUILD_LEVEL_BONUS_EXP, quantity = 0.05}, -- 5% EXP
		[5] = {level = 5, type = GUILD_LEVEL_BONUS_LOOT, quantity = 0.05}, -- 5% LOOT
		[6] = {level = 6, type = GUILD_LEVEL_BONUS_EXP, quantity = 0.08}, -- 8% EXP
		[7] = {level = 7, type = GUILD_LEVEL_BONUS_LOOT, quantity = 0.08}, -- 8% LOOT
		[8] = {level = 8, type = GUILD_LEVEL_BONUS_EXP, quantity = 0.10},  -- 10% EXP
		[9] = {level = 9, type = GUILD_LEVEL_BONUS_LOOT, quantity = 0.10}, -- 10% LOOT
		[10] = {level = 10, type = GUILD_LEVEL_BONUS_ELEMENTAL, quantity = 0.05} -- 5% ELEMENTAL RESISTANCE
	}
}
...
CONFIG_GUILD_MONSTERS = {
	...
	killingPlayer = {level = 500, pts = 150, msg = "The player %s killed someone above level 150 and earned %d points for your guild!"}
}
